    ...
    <div className="flex min-h-dvh flex-col items-center bg-bg text-ink">
      <SiteHeader>
        <form action="/auth/signout" method="post">
          <button
            type="submit"
            className="cursor-pointer rounded-[9px] border border-line px-3.5 py-2 text-[13px] font-semibold text-ink-soft transition-colors hover:bg-surface-alt hover:text-ink"
          >
            Log out
          </button>
        </form>
      ...
      <main className="flex w-full flex-1 items-center justify-center px-4 py-6">
        <div className="flex w-full max-w-[420px] flex-col gap-2 rounded-2xl border border-line bg-surface p-6 sm:p-8">
