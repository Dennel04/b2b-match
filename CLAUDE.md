...
- `src/lib/` — клиенты Supabase и Claude, скрапинг
...
## Приоритет
Сначала сквозной демо-сценарий из PLAN.md, раздел 3. Всё из «если успеем» — только когда основной путь работает end-to-end.
